...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //glStencilMask(0x00); // не обновляем буфер трафарета во время рисования пола
        ...
        {
            float distance = glm::distance(camera.Position, vegetation[i]);
